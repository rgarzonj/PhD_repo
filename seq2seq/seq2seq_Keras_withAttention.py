...
encoder_lstm = LSTM(latent_dim, return_sequences=True,return_state=False,unroll=True)

#encoder_last = encoder[0]
#encoder_outputs, state_h, state_c = encoder(encoder_inputs)
# encoder_hidden is ?,256
# encoder_outputs is ?,20,256

encoder = encoder_lstm(encoder_inputs)
encoder_last = encoder[:,-1,:]
encoder_states = [encoder[1],encoder[2]]
#print ('Encoder')
...
decoder_lstm = LSTM(latent_dim, return_sequences=True, return_state=False,unroll=True)
# decoder_outputs is ?,max_decoder_seq_length, 256 
# decoder_hidden is ?,256
#decoder_outputs,decoder_hidden , _ 
