...
from generate_data_variable_length import BW_data_generator
...
#        self.assertTrue(len(outp)>0)
    ...
    def test_generalizeInputDataset (self):
        inputSeq = "0 4 2 5 1 0 0 0 0 0 5 0 1 3 0 0 0 0 0 0"
        outputSeq = "3 0"
        inp,outp = self.bwgenerator._generalizeInputDataset(inputSeq,outputSeq)
        print (inputSeq)
        print (inp)
        print (outputSeq)
        print (outp)
